...
- [`PUBLIC_CONTRACT.md`](PUBLIC_CONTRACT.en.md) — v1 public contract: 80 methods, 58 events, capability handles, Path A / Path B, SDKs, and conformance
- [`CONTRACT_LAYERING_MATRIX.md`](CONTRACT_LAYERING_MATRIX.en.md) — candidate ownership matrix for the 80 methods, 58 events, and top-level schemas
...
- [`v1/schemas/`](v1/schemas/) — 177 JSON Schemas (80 methods + 58 events + 39 top-level), the SDK source of truth
