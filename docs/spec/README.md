...
- [`PUBLIC_CONTRACT.md`](PUBLIC_CONTRACT.md) — v1 公开契约：方法、事件、capability handle、Path A / Path B、SDK 与 conformance
- [`CONTRACT_LAYERING_MATRIX.md`](CONTRACT_LAYERING_MATRIX.md) — 方法、事件与顶层 schema 的 Candidate owner 矩阵
...
- [`v1/schemas/`](v1/schemas/) — 生成的 JSON Schema，SDK 的单一可信源；精确计数见 [`../ALPHA_STATUS.md`](../ALPHA_STATUS.md)
