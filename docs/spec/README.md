...
- [`PUBLIC_CONTRACT.md`](PUBLIC_CONTRACT.md) — v1 公开契约：92 个方法、69 个事件、capability handle、Path A / Path B、SDK 与 conformance
- [`CONTRACT_LAYERING_MATRIX.md`](CONTRACT_LAYERING_MATRIX.md) — 92 个方法、69 个事件与顶层 schema 的 Candidate owner 矩阵
...
- [`v1/schemas/`](v1/schemas/) — 200 个 JSON Schema（92 methods + 69 events + 39 top-level），SDK 的单一可信源
