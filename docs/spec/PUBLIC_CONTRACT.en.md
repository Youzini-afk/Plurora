...
| `host.surface.bundle.resolve` | partial | HostAdmin/HostDev only; resolve a mountable bundle URL from a package surface contribution; cross-source parity continues to harden. |
