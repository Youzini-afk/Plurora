...
- Contract V1 is the public platform spec: 80 protocol methods, 59 event kinds, and 161 JSON Schemas. `authority.handle.*`, `host.package.audit`, capability handles, binding injection, Path B, the conformance kit, and SDK generation are implemented.
