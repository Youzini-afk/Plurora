...
The independent project that's compatible with SillyTavern's resources and extensions and runs on Plurora is called **YdlTavern**. It lives in its own repo: <https://github.com/Youzini-afk/Plurora-Tavern>.

Platform and product stay separate — YdlTavern doesn't live in this repo and consumes the platform through the public protocol.
