...
- [`WORK_ASSEMBLY_REALIZATION.md`](WORK_ASSEMBLY_REALIZATION.md) — Work、Assembly、Installation、Run 与 Realization 的当前破坏性实施设计和 Codex 执行简报；完成后删除临时计划，并把长期语义收敛到正式架构、规范、指南与状态文档。
