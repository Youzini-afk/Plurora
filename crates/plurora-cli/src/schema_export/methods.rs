        ...
        .map(|method| {
            ...
            let (params, result) = match method {
                ...
                PlatformMethod::InstallationList => (
                    schema_value::<InstallationListRequest>(),
                    json!({"type":"array","items":schema_value::<InstallationView>()}),
                ),
                PlatformMethod::InstallationGet => (
                    schema_value::<InstallationGetRequest>(),
                    schema_value::<InstallationView>(),
                ),
                PlatformMethod::InstallationCreate => (
                    schema_value::<InstallationCreateRequest>(),
                    schema_value::<InstallationMutationResult>(),
                ),
                PlatformMethod::InstallationUpdate => (
                    schema_value::<InstallationUpdateRequest>(),
                    schema_value::<InstallationMutationResult>(),
                ),
                ...
                PlatformMethod::AssetPut => (
                    ...
                    schema_value::<ObjectPutResponse>(),
                ),
                PlatformMethod::AssetGet => (
                    schema_value::<ObjectGetRequest>(),
                    schema_value::<ObjectGetResponse>(),
                ),
                ...
                PlatformMethod::HostInfo => {
                    (schema_value::<EmptyParams>(), schema_value::<HostInfo>())
                }
