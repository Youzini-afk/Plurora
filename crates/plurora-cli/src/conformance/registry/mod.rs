...
pub(super) fn build_cases() -> Vec<ConformanceCase> {
    ...
    cases.extend(first_party_experience_agent::first_party_foundation_labs_cases());
    ...
    cases.extend(super::run::run_cases());
    ...
    cases.extend(first_party_experience_agent::inference_local_cases());
    cases.extend(first_party_experience_agent::inference_playtest_cases());
    cases.extend(first_party_experience_agent::agentic_forge_phase_a_cases());
    cases.extend(first_party_experience_agent::agentic_forge_phase_b_cases());
    cases.extend(first_party_experience_agent::agentic_forge_phase_c_cases());
    cases.extend(first_party_experience_agent::agentic_forge_phase_d_cases());
    cases.extend(first_party_experience_agent::agentic_forge_phase_f_cases());
    cases.extend(first_party_experience_agent::experience_runtime_cases());
    cases.extend(first_party_experience_agent::playable_board_beta_1_cases());
    cases.extend(first_party_experience_agent::playable_board_beta_2_cases());
