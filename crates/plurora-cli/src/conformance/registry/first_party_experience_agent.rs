...
pub(super) fn first_party_foundation_labs_cases() -> Vec<ConformanceCase> {
    vec![
        ...
        c!(
            ...
            ["first_party", "slow"],
            crate::conformance::first_party_foundation::foundation_packages
        ),
        c!(
            "first_party.assistant_lab_proposal",
            ["first_party", "slow"],
            crate::conformance::first_party_labs::assistant_lab_proposal
        ),
        c!(
...
pub(super) fn agentic_forge_phase_f_cases() -> Vec<ConformanceCase> {
    vec![
        ...
        c!(
            ...
            ["agentic", "first_party"],
            crate::conformance::agentic_forge::agentic_forge_no_publisher_priority
        ),
        c!(
...
pub(super) fn playable_board_beta_1_cases() -> Vec<ConformanceCase> {
    ...
    c!(
        "playable_board.thirdparty_no_publisher_priority",
        ["experience", "replacement"],
        crate::conformance::playable_creation_board::playable_board_thirdparty_no_publisher_priority
    ),
    c!(
...
pub(super) fn playable_board_beta_2_cases() -> Vec<ConformanceCase> {
    vec![
        ...
        c!(
            "first_party.asset_lab_content_address",
            ["first_party", "slow"],
            crate::conformance::first_party_labs::asset_lab_content_address
        ),
        c!(
            "first_party.asset_lab_provenance_graph",
            ["first_party", "slow"],
            crate::conformance::first_party_labs::asset_lab_provenance_graph
        ),
        c!(
            "first_party.projection_lab_state_snapshot",
            ["first_party", "slow"],
            crate::conformance::first_party_labs::projection_lab_state_snapshot
        ),
    ]
}
