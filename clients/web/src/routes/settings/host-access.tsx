...
function scopeLabel(scope: HostAccessScope, t: ReturnType<typeof useT>): string {
  return t({
    ...
    "realization.plan": "accessScopeRealization",
    "realization.apply": "accessScopeRealization",
...
function scopeDescription(scope: HostAccessScope, t: ReturnType<typeof useT>): string {
  return t({
    ...
    "realization.plan": "accessScopeRealizationBody",
    "realization.apply": "accessScopeRealizationBody",
